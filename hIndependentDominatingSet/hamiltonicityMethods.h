...
bool isHamiltonianCIndependentVersion(bitset adjacencyList[], int numberOfVertices, bool allCyclesFlag, int upperBound, Array *a, unsigned long long int * numValidGraphCyclePairs, char * graphString, bool verboseFlag);
